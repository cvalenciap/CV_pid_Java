...
//    	cadena=URLDecoder.decode(cadena, "UTF-8");
  ...
  //Se utiliza jackson debido a que con gson se tuvo problemas con los numericos
    public static String convertirObjetoACadenaJsonMapper(Object cadena) throws GmdException{        
  ...
  //Se utiliza jackson debido a que con gson se tuvo problemas con los numericos
    public static <T> T convertirCadenaJsonPostAListObjeto(String cadena, Class<T> clase) throws GmdException{        
    ...
    public  static <T> T convertirObjetoaMapString(Object objeto) throws JsonParseException, JsonMappingException, IOException, GmdException{
    	try {
    		//String ObjetoJSON = convertirObjetoACadenaJson(objeto);
    ...
    public  static <T> T convertirObjetoaMapStringOnly(Object objeto) throws JsonParseException, JsonMappingException, IOException, GmdException{
    	try {
    		//String ObjetoJSON = convertirObjetoACadenaJson(objeto);
    		String ObjetoJSON = convertirObjetoACadenaJsonMapper(objeto);
    ...
    public  static <T> T convertirObjetoaMapStringConEnter(Object objeto) throws JsonParseException, JsonMappingException, IOException, GmdException{
    	try {
    		//String ObjetoJSON = convertirObjetoACadenaJson(objeto);
    ...
    public static String convertirObjetoACadenaJsonMapperConEnter(Object cadena) throws GmdException{     
			try {
